...
class Roboto(Layer):
    ...
    def movement_anim(self, flag1 = False, flag2 = False, flag3 = False):
        if flag1 == True and self.sprite.y == 80:
        ...
        elif flag2 == True and self.sprite.y == 80:
    ...
    def fight_anim(self, flag1 = False, flag2 = False):
        if flag1 == True:
            self.anim = pyglet.image.Animation.from_image_sequence(shooting_grid[0:], 0.1)
            pyglet.sprite.Sprite.__init__(self.sprite, self.anim, x = self.sprite.x, y = self.sprite.y)
        elif flag2 == True:
            self.anim = pyglet.image.Animation.from_image_sequence(kick_grid[0:], 0.1)
            pyglet.sprite.Sprite.__init__(self.sprite, self.anim, x = self.sprite.x, y = self.sprite.y)
        else:
            self.movement_anim()
    ...
    def on_key_release(self, symbol, modifiers):
        if symbol == pyglet.window.key.LEFT:
            ...
            self.movement_anim(flag3 = False)
